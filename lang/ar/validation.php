...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | تحتوي السطور اللغوية التالية على رسائل الأخطاء الافتراضية المستخدمة من قبل
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute المقدم ظهر في تسريب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | السطور اللغوية التالية تستخدم لاستبدال العنصر النائب للسمة
    ...
    */
    ...
    'attributes' => [
        ...
        'type_of_marriage'          => 'نوع الزواج',
        'age'                       => 'العمر',
        'children'                  => 'عدد الأبناء',
        'weight'                    => 'الوزن',
        'height'                    => 'الطول',
        'skin_color'                => 'لون البشرة',
        'physique'                  => 'البنية الجسدية',
        'religious_commitment'      => 'الالتزام الديني',
        'prayer'                    => 'الصلاة',
        'smoking'                   => 'التدخين',
        'hijab'                     => 'الحجاب',
        'educational_qualification' => 'المؤهل العلمي',
        'financial_situation'       => 'الوضع المالي',
        'job'                       => 'الوظيفة',
        'work_field'                => 'مجال العمل',
        'income'                    => 'الدخل',
        'health_condition'          => 'الحالة الصحية',
        'life_partner'              => 'المواصفات المطلوبة في الشريك',
        'about_me'                  => 'نبذة عني',
    ],
